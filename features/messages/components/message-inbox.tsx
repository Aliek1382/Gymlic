...
const COPY = {
  athlete: {
    emptyTitle: "هنوز مربی‌ای ندارید.",
    emptyDescription:
      "به محض اینکه به مربی وصل شوید، می‌توانید همین‌جا با او گفتگو کنید — حتی پیش از اینکه برنامه‌ای برایتان ثبت شود.",
  },
  trainer: {
    emptyTitle: "هنوز ورزشکاری ندارید.",
    emptyDescription:
      "پس از پذیرفته‌شدن اولین دعوت، گفتگو با ورزشکارتان از همین‌جا ممکن می‌شود.",
  },
} as const;
