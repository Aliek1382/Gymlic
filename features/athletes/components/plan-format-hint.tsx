...
const EXAMPLES: { label: string; lines: string[] }[] = [
  ...
  {
    label: "استراحت — در انتهای همان خط، بدون پرانتز یا ویرگول",
    lines: [
      "پرس سینه 4x12 استراحت 60 ثانیه",
      "پرس سینه 4x12 استراحت 1 دقیقه",
      "پرس سینه 4x12 استراحت بین حرکات 2 دقیقه",
    ],
  },
  {
